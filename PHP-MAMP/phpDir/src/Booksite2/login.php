...
// If username and password are set, create a new user
    if (isset($_POST["title"]) && isset($_POST["author"]) && isset($_POST["year"]) && isset($_POST["genre"]) && isset($_POST["description"])) {
...
// Bind the username and password parameters to the prepared statement
        $stmt->bind_param("ssiss", $_POST["title"], $_POST["author"], $_POST['year'], $_POST['genre'], $_POST['description']);
...
// Bind the edit_username, edit_password, and edit_id parameters to the prepared statement
        $stmt->bind_param("ssissi", $_POST["edit_title"], $_POST["edit_author"], $_POST['edit_year'], $_POST['edit_genre'], $_POST['edit_description'], $_POST["edit_id"]);
// Execute the prepared statement
        $stmt->execute();
// Close the prepared statement
        $stmt->close();
